...
class AllCategoryViewcontroller: BaseViewController, UIViewControllerTransitioningDelegate {
   ...
   lazy var addLinkButton = {
    ...
    @objc func searchbuttonTapped() {
        navigationController?.pushViewController(AllSearchViewController(), animated: true)
...
extension AllCategoryViewcontroller: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    extension AllCategoryViewcontroller:  UISearchBarDelegate, UISearchControllerDelegate {
